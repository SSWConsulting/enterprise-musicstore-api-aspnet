...
namespace SSW.MusicStore.Data
{
	public class SampleDataSeeder : IDataSeeder
	{
	    ...
	    private void InsertTestData<TDbContext>(TDbContext dbContext) where TDbContext : DbContext
	    {
	        ...
	        this.AddOrUpdate(dbContext, p => p.GenreId, Genres.Select(genre => genre.Value));
	        this.AddOrUpdate(dbContext, a => a.ArtistId, Artists.Select(artist => artist.Value));
	        this.AddOrUpdate(dbContext, a => a.AlbumId, albums);
	    }
